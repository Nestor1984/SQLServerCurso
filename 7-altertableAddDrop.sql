create database altertableAddDrop;

use altertableAddDrop;
...
create table Empleados(
 ...
 insert into empleados values (1, 'Juan', 'Pérez', 25, 1234567890, 'Calle 123', '1978-06-15', 2500.00, 'SI');
  ...
  /*alter table - add: Nos sirve para crear un nuevo campo*/
  alter table empleados
  add sexo char(1);

  alter table Empleados
  add fe_contratacion date;

  /*alter table - drop column: Nos sirve para eliminar un campo*/
  alter table Empleados
  drop column fe_contratacion;
