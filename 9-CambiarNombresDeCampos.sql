create database cambiarNombresDeCampos;
use cambiarNombresDeCampos;
...
create table Empleados(
  ...
  -- Cambiamos el nombre del campo idempleado a id
  /* Sintaxis:
     exec sp_rename 'nombreDeLaTabla.elCampoAlQueLeVoyACambiarElNombre' , 'nuevoNombre';
  */
