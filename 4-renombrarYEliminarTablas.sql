create database renombrarYEliminarTablas;
use renombrarYEliminarTablas;
...
/*Renombrar tablas de (empleado a usuarios)*/
exec sp_rename 'Empleados', 'Usuarios'; /*exec sp_rename 'AntiguoNombre', 'NuevoNombre';*/
