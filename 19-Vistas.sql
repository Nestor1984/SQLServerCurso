...
/*Una vista: es una tabla virtual basada en el resultado de una consulta*/
...
--insertar estos registros en la tabla clientes
	...
	-- PRIMER EJEMPLO:
	-- Creamos una vista
	create view Clientes_Nacionales -- create view NombreDeLaVista
	as -- as: que va contener esa vista
	select * from clientes; -- Lo que va contener es este select
	...
	-- ACTUALIZAMOS UNA VISTA
	-- Quisiera ver ahora tambien el campo fecha de nacimiento
