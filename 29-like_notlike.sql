...
ciudad varchar(30) not null
  ...
  -- Quiero ver los nombres que empiecen con la letra "a":
  select * from clientes
  where nombre like 'A%';

  -- Quiero ver los nombres que terminen con la letra "a":
  select * from clientes
  where nombre like '%A';

  -- Traer los nombre que tienen una "a" como segundo caracter
  select * from clientes
  where nombre like '_a%'; -- _: cuenta como caracter

  -- Traer las palabras que empiezan con "a" y terminan con "o".
  select * from clientes
  where nombre like 'a%o';

  -- Traer los nombres que no tienen como segundo caracter la "a".
  select * from clientes
