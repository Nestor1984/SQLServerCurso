create database truncateTableYDeleteFrom;
use truncateTableYDeleteFrom;
...
create table Empleados(
 ...
 insert into empleados values (1, 'Juan', 'Pérez', 25, 1234567890, 'Calle 123', '1978-06-15', 2500.00, 'SI');
  ...
  /*Truncate Table: sirve para eliminar registros sin la tabla*/
  truncate table Empleados;

  /*Delete from: sirve para eliminar un registro en especifico*/
