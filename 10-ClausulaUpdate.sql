create database clausulaUpdate;
use clausulaUpdate;
...
create table Empleados(
  ...
  insert into empleados values (6, 'Laura', 'Ramírez', 31, 4444444444, 'Avenida 890', '1978-07-12', 3200.00, 'NO');
  ...
  insert into empleados values (11, 'Roberto', 'Rojas', 26, 3334445556, 'Calle 567', '1979-02-14', 2400.00, 'NO');
  ...
  -- Cambiamos el numero telefonico de Carlos Gonzales
  update Empleados
  set telefono = 800333444
  where id = 3;
  select * from Empleados;

  -- Cambiamos el activo a SI
  update empleados
  set activo = 'SI';

  -- Cambiamos el activo a no usando la instruccion in
  update Empleados
  set activo = 'NO'
  where id in(1, 3, 5, 7, 9);

  -- Borramos las filas 3, 8 y 15
